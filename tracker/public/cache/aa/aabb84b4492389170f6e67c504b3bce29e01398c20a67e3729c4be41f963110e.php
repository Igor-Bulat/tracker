...
/* navbar.tpl.php */
class __TwigTemplate_fd4c77d7534dfb6a18fb737e37fbb2fcdb43c0f7799a7fc32df7f89def31bfe1 extends Twig_Template
{
 ...
 ";
  ...
  <li class=\"w3-left uppercase\"><a href=\"?user/login\">";
            // line 12
            echo twig_escape_filter($this->env, trans("Create torrent", "Создать торрент", "Face nou torrent"), "html", null, true);
            echo "</a></li>
    ";
        } else {
            // line 14
...
";
 ...
 {% if login == false %}
  ...
  <li class=\"w3-left uppercase\"><a href=\"?user/login\">{{translate('Create torrent','Создать торрент','Face nou torrent')}}</a></li>
    {% else %}
    <li class=\"w3-right uppercase\">
    <a href=\"?user/logout\">{{translate('Logout','Выход','Iesire')}}</a>
    </li>
    <li class=\"w3-left uppercase\"><a href=\"?torrent/create\">{{translate('Create torrent','Создать торрент','Face nou torrent')}}</a></li>
    {% endif %}
</ul>
<ul class=\"w3-navbar w3-white w3-right w3-border\">
  <li><a href=\"?lang/en\">EN</a></li>
